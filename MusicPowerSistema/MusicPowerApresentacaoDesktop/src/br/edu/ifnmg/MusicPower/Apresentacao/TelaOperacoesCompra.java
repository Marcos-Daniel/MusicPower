 ...
 * @author breno
 */
public class TelaOperacoesCompra extends javax.swing.JFrame {
    ...
    Compra compra;
    int ultimaCompra;
    CompraRepositorio daoCompra = GerenciadorDeReferencias.getCompra();
    ItensCompra daoItensCompra = new ItensCompra();
    ...
    private void initComponents() {
        ...
        pnlCliente.setBorder(javax.swing.BorderFactory.createTitledBorder("Dados da Compra"));
            ...
            .addGroup(pnlClienteLayout.createSequentialGroup()
                ...
                .addGroup(pnlClienteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlClienteLayout.createSequentialGroup()
                        ...
                        .addGap(319, 319, 319))
                    .addGroup(pnlClienteLayout.createSequentialGroup()
                        .addComponent(txtIdFornecedor, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pnlItensVenda.setBorder(javax.swing.BorderFactory.createTitledBorder("Itens Compra"));
    ...
    private void btnAdicionarProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarProdutoActionPerformed
        ...
        try {
            ...
            Logger.getLogger(TelaOperacoesCompra.class.getName()).log(Level.SEVERE, null, ex);
        }
            listaCompra.add(novo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaOperacoesCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaOperacoesCompra().setVisible(true);
            }
        });
    }
    ...
    public void efetuarCompra(){
        ...
        Double valorCompra = calcularCompra();
        Date date = new Date( new java.util.Date().getTime());
        compra = new Compra(0,idFornecedor,idFuncionario,valorCompra,date);
       
        try {
           MPA.criarCompra(compra);
    ...
    private void guardaItensCompra() {
        for(Produto c: listaCompra){
            idProduto = c.getId();
            qtd = c.getQtd();
            ...
            try {
                MPA.criarItensCompra(daoItensCompra);
            } catch (SQLException ex) {
                Logger.getLogger(TelaOperacoesCompra.class.getName()).log(Level.SEVERE, null, ex);
            } catch (ClassNotFoundException ex) {
                Logger.getLogger(TelaOperacoesCompra.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void buscarUltimoId() {
        ultimaCompra = daoCompra.buscarUltimoId();
    }
