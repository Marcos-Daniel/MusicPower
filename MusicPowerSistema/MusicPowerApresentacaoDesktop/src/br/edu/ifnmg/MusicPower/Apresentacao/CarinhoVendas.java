 ...
 * @author breno
 */
public class CarinhoVendas extends javax.swing.JFrame {

    /**
     * Creates new form carinhoCompras
     */
    public CarinhoVendas() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CarinhoVendas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CarinhoVendas().setVisible(true);
            }
        });
    }
