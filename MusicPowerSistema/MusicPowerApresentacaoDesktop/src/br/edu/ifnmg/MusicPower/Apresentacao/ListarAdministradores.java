 ...
 * @author marcos
 */
public class ListarAdministradores extends javax.swing.JFrame {

    AdministradorRepositorio dao;
    Administrador funcionario = new Administrador();
    ArrayList<Administrador> busca = new ArrayList<>();
    ...
    public ListarAdministradores() {
        initComponents();
        this.dao = GerenciadorDeReferencias.getAdministrador();
    }
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if(posicao>=0){
            Administrador administrador = busca.get(posicao);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if(posicao >= 0){
            ...
            if(opcao == JOptionPane.YES_OPTION ){
                CadastrarAdministrador telaCadastrarAdministrador = new CadastrarAdministrador(administrador,this);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.dispose();
        CadastrarAdministrador telaCadastrarAdmnistrador = new CadastrarAdministrador();
        telaCadastrarAdmnistrador.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarAdministradores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarAdministradores().setVisible(true);
            }
        });
    }
    ...
    private void buscar(String nome, String cpf) throws ParseException {
        ...
        busca = (ArrayList<Administrador>) dao.Buscar(filtro);
        preencherTabela(busca);
